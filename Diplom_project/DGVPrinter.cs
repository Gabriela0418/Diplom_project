...
namespace DGVPrinterHelper //AllocationRequest
{
    ...
    public class DGVPrinter
    {
        ...
        public void CreateReport(string nameTitle,string prod, DataGridView grid)
        {
            var printer = new DGVPrinter();
            printer.Title = nameTitle;
            printer.SubTitle = $"\n\n{prod}\n\n Дата создания отчета {DateTime.Now.ToString("dd MMM")}\n\n";
            printer.SubTitleHorizontalAlign = HorizontalAlignment.Left;
        ...
        public Alignment SubTitleAlignment
        {
            get { return alignment; }
            set { alignment = value; }
        }
        private HorizontalAlignment subtitleHorizontalAlign;
        public HorizontalAlignment SubTitleHorizontalAlign
        {
            get { return subtitleHorizontalAlign; }
            set { subtitleHorizontalAlign = value; }
        }
        /// <summary>
